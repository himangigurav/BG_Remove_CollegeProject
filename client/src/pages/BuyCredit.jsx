 ...
 const BuyCredit = () => {
  return (
    <div className='min-h-[80vh] text-center pt-14 mb-10'>
      ...
      <h1 className='text-center text-2xl md:text-3xl lg:4xl mt-4 font-semibold bg-gradient-to-r from-gray-900 to-blue-400 bg-clip-text text-transparent mb-6 sm:mb-10'>Choose the plan that's right for you</h1>
      <div className='flex flex-wrap justify-center gap-6 text-left'>
        {plans.map((item,index)=>(
         <div className='bg-white drop-shadow-sm border rounded-lg py-12 px-8 text-gray-700 hover:scale-105 transition-all duration-700' key={index}>
          <img width={40} scr={assets.logo_icon} />
